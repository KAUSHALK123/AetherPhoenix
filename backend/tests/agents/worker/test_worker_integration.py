...
from shared.contracts.execution import ExecutionResult, ExecutionMetrics
...
def integration_environment():
    ...
    tool_registry.register(Tool(
        ...
        status=ToolState.READY,
        health=ToolHealth.HEALTHY,
        required_permissions=[PermissionType.FILE_SYSTEM.value, PermissionType.FILE_SYSTEM_WRITE.value]
    ))
