...
# even in ASSISTED mode. AUTONOMOUS mode might still execute them if explicitly
# configured, but usually, these are the dangerous operations.
...
class PermissionPolicy:
    ...
    def requires_approval(permission_type: PermissionType, mode: str) -> bool:
        """
        Determines if a given permission requires explicit user approval based on the
        execution mode.
        """
